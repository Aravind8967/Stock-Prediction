from analysis import Company_details, PredictValues
import numpy as np
...
def add_values(years, revenue, income, target_start_year = 2012):
    revenue_growth = []
    income_growth = []
...
if __name__ == '__main__':
    ...
    prev_ext = add_values(data['years'], data['revenue'], data['net_income'])
